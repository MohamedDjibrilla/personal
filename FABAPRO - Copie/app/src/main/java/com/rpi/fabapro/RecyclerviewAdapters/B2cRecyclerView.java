...
import com.rpi.fabapro.Activities.DetailsServices;
...
public class B2cRecyclerView extends RecyclerView.Adapter<B2cRecyclerView.Holder>{
    private Context mContext;
    private ArrayList<professionnels> prof;

    public B2cRecyclerView(Context context, ArrayList<professionnels>profs){
        mContext = context;
        this.prof=profs;
    }
            ...
            holder.ParentLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(holder.Disponibilite.getText().equals("Indisponible")){
                        ...
                        Intent intent = new Intent(mContext, DetailsServices.class);
