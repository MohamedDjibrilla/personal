...
import com.rpi.fabapro.Activities.DetailsRestorations;
...
public class RestaurantRecyclerView extends RecyclerView.Adapter<RestaurantRecyclerView.Holder> {
    private Context mContext;
    private ArrayList<professionnels> prof;

    public RestaurantRecyclerView(Context mContext, ArrayList<professionnels> prof) {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        RestaurantRecyclerView.Holder holder= new RestaurantRecyclerView.Holder(view);
        return holder;
    }
            ...
            holder.ParentLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(holder.Disponibilite.getText().equals("Indisponible")){
                        ...
                        Intent intent = new Intent(mContext, DetailsRestorations.class);
